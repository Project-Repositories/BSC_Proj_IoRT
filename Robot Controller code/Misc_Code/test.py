import time
from Hardware_Controllers.Led import *
...
def test_Motor():
    try:
        ...
        time.sleep(1)
        PWM.set_motor_model(-1500, -1500, 2000, 2000)  # Left
        print("The car is turning left")
        time.sleep(1)
        PWM.set_motor_model(2000, 2000, -1500, -1500)  # Right
...
from Hardware_Controllers.Ultrasonic import *
...
from Hardware_Controllers.servo import *
...
from Hardware_Controllers.ADC import *
...
from Hardware_Controllers.Buzzer import *
